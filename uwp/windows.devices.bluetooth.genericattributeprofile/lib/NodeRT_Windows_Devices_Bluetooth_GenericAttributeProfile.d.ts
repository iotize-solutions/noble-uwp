declare module 'windows.devices.bluetooth.genericattributeprofile' {
    ...
    export class GattDeviceService {
        ...
        static fromIdAsync(
            deviceId: String,
            sharingMode: GattSharingMode,
            callback: (error: Error, result: GattDeviceService) => void
        ): void;
        static fromIdAsync(
            deviceId: String,
            callback: (error: Error, result: GattDeviceService) => void
        ...
        static getDeviceSelectorForBluetoothDeviceId(
        ...
        static getDeviceSelectorForBluetoothDeviceIdAndUuid(
            bluetoothDeviceId: Object,
            serviceUuid: String
        ): String;
        static getDeviceSelectorForBluetoothDeviceIdAndUuid(
        ...
        openAsync(
            sharingMode: GattSharingMode,
            callback: (error: Error, result: GattOpenStatus) => void
        ): void;

        getCharacteristicsAsync(
            callback: (error: Error, result: GattCharacteristicsResult) => void
        ): void;
        getCharacteristicsAsync(
            cacheMode: Number,
            callback: (error: Error, result: GattCharacteristicsResult) => void
        ...
        getIncludedServicesAsync(
            callback: (error: Error, result: GattDeviceServicesResult) => void
        ): void;
        getIncludedServicesAsync(
            cacheMode: Number,
            callback: (error: Error, result: GattDeviceServicesResult) => void
    ...
    export class GattSession {
        ...
        static fromDeviceIdAsync(
            deviceId: Object,
            callback: (error: Error, result: GattSession) => void
        ): void;

        close(): void;
        addListener(
            type: 'MaxPduSizeChanged',
    ...
    export class GattCharacteristic {
        ...
        readValueAsync(
            callback: (error: Error, result: GattReadResult) => void
        ): void;
        readValueAsync(
            cacheMode: Number,
            callback: (error: Error, result: GattReadResult) => void
        ...
        writeValueAsync(
            value: Object,
            callback: (error: Error, result: GattCommunicationStatus) => void
        ): void;
        writeValueAsync(
            value: Object,
        ...
        readClientCharacteristicConfigurationDescriptorAsync(
            callback: (
                error: Error,
                result: GattReadClientCharacteristicConfigurationDescriptorResult
            ) => void
        ): void;
        ...
        getDescriptorsAsync(
            callback: (error: Error, result: GattDescriptorsResult) => void
        ): void;
        getDescriptorsAsync(
            cacheMode: Number,
            callback: (error: Error, result: GattDescriptorsResult) => void
        ...
        writeValueWithResultAsync(
            value: Object,
            callback: (error: Error, result: GattWriteResult) => void
        ): void;
        writeValueWithResultAsync(
            value: Object,
            writeOption: GattWriteOption,
    ...
    export class GattServiceProvider {
        ...
        static createAsync(
            serviceUuid: String,
            callback: (error: Error, result: GattServiceProviderResult) => void
        ): void;
    ...
    export class GattLocalCharacteristic {
        ...
        createDescriptorAsync(
            ...
            callback: (error: Error, result: GattLocalDescriptorResult) => void
        ): void;
        ...
        notifyValueAsync(
            ...
            callback: (
                error: Error,
                result: GattClientNotificationResult
            ) => void
        ): void;
    ...
    export class GattSubscribedClient {
        ...
        addListener(
            type: 'MaxNotificationSizeChanged',
            listener: (ev: Event) => void
        ): void;
        removeListener(
            type: 'MaxNotificationSizeChanged',
    ...
    export class GattReadRequestedEventArgs {
        ...
        getRequestAsync(
            callback: (error: Error, result: GattReadRequest) => void
        ): void;
    ...
    export class GattWriteRequestedEventArgs {
        ...
        getRequestAsync(
            callback: (error: Error, result: GattWriteRequest) => void
        ): void;
