...
GattDeviceService = (function() {
    ...
    cls.prototype.getCharacteristicsAsync = function getCharacteristicsAsync(
        callback
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.prototype.getCharacteristicsForUuidAsync = function getCharacteristicsForUuidAsync(
        characteristicUuid,
        callback
    ) {
        /// <signature>
    ...
    cls.prototype.getIncludedServicesAsync = function getIncludedServicesAsync(
        callback
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.prototype.getIncludedServicesForUuidAsync = function getIncludedServicesForUuidAsync(
        serviceUuid,
        callback
    ) {
        /// <signature>
    ...
    cls.prototype.getCharacteristics = function getCharacteristics(
        characteristicUuid
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.prototype.getIncludedServices = function getIncludedServices(
        serviceUuid
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.getDeviceSelectorForBluetoothDeviceId = function getDeviceSelectorForBluetoothDeviceId(
        bluetoothDeviceId
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.getDeviceSelectorForBluetoothDeviceIdAndUuid = function getDeviceSelectorForBluetoothDeviceIdAndUuid(
        bluetoothDeviceId,
        serviceUuid
    ) {
        /// <signature>
    ...
    cls.getDeviceSelectorFromUuid = function getDeviceSelectorFromUuid(
        serviceUuid
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.getDeviceSelectorFromShortId = function getDeviceSelectorFromShortId(
        serviceShortId
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
...
GattSession = (function() {
    ...
    cls.prototype.removeListener = function removeListener(
        eventName,
        callback
    ) {};
...
GattCharacteristic = (function() {
    ...
    cls.prototype.readValueAsync = function readValueAsync(
        cacheMode,
        callback
    ) {
        /// <signature>
    ...
    cls.prototype.writeValueAsync = function writeValueAsync(
        value,
        writeOption,
        callback
    ) {
    ...
    cls.prototype.readClientCharacteristicConfigurationDescriptorAsync = function readClientCharacteristicConfigurationDescriptorAsync(
        callback
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.prototype.writeClientCharacteristicConfigurationDescriptorAsync = function writeClientCharacteristicConfigurationDescriptorAsync(
    ...
    cls.prototype.getDescriptorsAsync = function getDescriptorsAsync(
        cacheMode,
        callback
    ) {
        /// <signature>
    ...
    cls.prototype.getDescriptorsForUuidAsync = function getDescriptorsForUuidAsync(
        descriptorUuid,
        callback
    ) {
        /// <signature>
    ...
    cls.prototype.writeValueWithResultAsync = function writeValueWithResultAsync(
        value,
        callback
    ) {
        /// <signature>
    ...
    cls.prototype.writeClientCharacteristicConfigurationDescriptorWithResultAsync = function writeClientCharacteristicConfigurationDescriptorWithResultAsync(
        clientCharacteristicConfigurationDescriptorValue,
        callback
    ) {
        /// <signature>
...
GattPresentationFormat = (function() {
    ...
    cls.fromParts = function fromParts(
        formatType,
        exponent,
        unit,
        namespaceId,
...
GattReliableWriteTransaction = (function() {
    ...
    cls.prototype.commitWithResultAsync = function commitWithResultAsync(
        callback
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
...
GattLocalService = (function() {
    ...
    cls.prototype.createCharacteristicAsync = function createCharacteristicAsync(
        characteristicUuid,
        parameters,
        callback
    ) {
...
GattLocalCharacteristic = (function() {
    ...
    cls.prototype.createDescriptorAsync = function createDescriptorAsync(
        descriptorUuid,
        parameters,
        callback
    ) {
    ...
    cls.prototype.notifyValueAsync = function notifyValueAsync(
        value,
        callback
    ) {
        /// <signature>
...
GattReadRequest = (function() {
    ...
    cls.prototype.respondWithProtocolError = function respondWithProtocolError(
        protocolError
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
