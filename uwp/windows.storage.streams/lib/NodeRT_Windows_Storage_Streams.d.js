...
Buffer = (function() {
    ...
    cls.createCopyFromMemoryBuffer = function createCopyFromMemoryBuffer(
        input
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.createMemoryBufferOverIBuffer = function createMemoryBufferOverIBuffer(
        input
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
...
RandomAccessStream = (function() {
    ...
    cls.copyAsync = function copyAsync(
        source,
        destination,
        bytesToCopy,
        callback
    ...
    cls.copyAndCloseAsync = function copyAndCloseAsync(
        source,
        destination,
        callback
    ) {
...
IInputStreamReference = (function() {
    ...
    cls.prototype.openSequentialReadAsync = function openSequentialReadAsync(
        callback
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
