declare module 'windows.devices.enumeration' {
    ...
    export class DevicePicker {
        ...
        pickSingleDeviceAsync(
            selection: Object,
            callback: (error: Error, result: DeviceInformation) => void
        ): void;
        pickSingleDeviceAsync(
            selection: Object,
            placement: Number,
    ...
    export class DeviceInformation {
        ...
        getThumbnailAsync(
            callback: (error: Error, result: DeviceThumbnail) => void
        ): void;
    ...
    export class DeviceInformationCustomPairing {
        ...
        pairAsync(
            ...
            callback: (error: Error, result: DevicePairingResult) => void
        ): void;
        pairAsync(
            pairingKindsSupported: DevicePairingKinds,
    ...
    export class DeviceInformationPairing {
        ...
        unpairAsync(
            callback: (error: Error, result: DeviceUnpairingResult) => void
        ): void;
    }
    ...
    export class DeviceAccessInformation {
        ...
        static createFromDeviceClassId(
