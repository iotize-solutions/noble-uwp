...
DevicePicker = (function() {
    ...
    cls.prototype.pickSingleDeviceAsync = function pickSingleDeviceAsync(
        selection,
        callback
    ) {
        /// <signature>
    ...
    cls.prototype.setDisplayStatus = function setDisplayStatus(
        device,
        status,
        options
    ) {
...
DeviceThumbnail = (function() {
    ...
    cls.prototype.readAsync = function readAsync(
        buffer,
        count,
        options,
        callback
...
DeviceWatcher = (function() {
    ...
    cls.prototype.getBackgroundTrigger = function getBackgroundTrigger(
        requestedEventKinds
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
...
DeviceInformation = (function() {
    ...
    cls.prototype.getGlyphThumbnailAsync = function getGlyphThumbnailAsync(
        callback
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.createFromIdAsync = function createFromIdAsync(
        deviceId,
    ...
    cls.findAllAsync = function findAllAsync(
        aqsFilter,
        additionalProperties,
        kind,
        callback
    ...
    cls.getAqsFilterFromDeviceClass = function getAqsFilterFromDeviceClass(
        deviceClass
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
...
DeviceInformationCustomPairing = (function() {
    ...
    cls.prototype.pairAsync = function pairAsync(
...
DeviceInformationPairing = (function() {
    ...
    cls.tryRegisterForAllInboundPairingRequests = function tryRegisterForAllInboundPairingRequests(
        pairingKindsSupported
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
...
DeviceAccessInformation = (function() {
    ...
    cls.createFromDeviceClassId = function createFromDeviceClassId(
        deviceClassId
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
