...
BluetoothDevice = (function() {
    ...
    cls.prototype.getRfcommServicesAsync = function getRfcommServicesAsync(
        callback
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.prototype.getRfcommServicesForIdAsync = function getRfcommServicesForIdAsync(
        serviceId,
        callback
    ) {
        /// <signature>
    ...
    cls.fromBluetoothAddressAsync = function fromBluetoothAddressAsync(
        address,
        callback
    ) {
        /// <signature>
    ...
    cls.getDeviceSelectorFromPairingState = function getDeviceSelectorFromPairingState(
        pairingState
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.getDeviceSelectorFromConnectionStatus = function getDeviceSelectorFromConnectionStatus(
        connectionStatus
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.getDeviceSelectorFromDeviceName = function getDeviceSelectorFromDeviceName(
        deviceName
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.getDeviceSelectorFromBluetoothAddress = function getDeviceSelectorFromBluetoothAddress(
        bluetoothAddress
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.getDeviceSelectorFromClassOfDevice = function getDeviceSelectorFromClassOfDevice(
        classOfDevice
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
...
BluetoothLEDevice = (function() {
    ...
    cls.prototype.getGattServicesAsync = function getGattServicesAsync(
        callback
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
    ...
    cls.prototype.getGattServicesForUuidAsync = function getGattServicesForUuidAsync(
        serviceUuid,
        callback
    ) {
        /// <signature>
    ...
    cls.getDeviceSelectorFromAppearance = function getDeviceSelectorFromAppearance(
        appearance
    ) {
        /// <signature>
        /// <summary>Function summary.</summary>
