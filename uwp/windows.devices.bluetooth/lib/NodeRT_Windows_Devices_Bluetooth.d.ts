declare module 'windows.devices.bluetooth' {
    ...
    export class BluetoothAdapter {
        ...
        static fromIdAsync(
            deviceId: String,
            callback: (error: Error, result: BluetoothAdapter) => void
        ): void;
    ...
    export class BluetoothDevice {
        ...
        static fromIdAsync(
            deviceId: String,
            callback: (error: Error, result: BluetoothDevice) => void
        ): void;
        ...
        static getDeviceSelectorFromClassOfDevice(
            classOfDevice: BluetoothClassOfDevice
        ): String;
    ...
    export class BluetoothLEDevice {
        ...
        static fromBluetoothAddressAsync(
            bluetoothAddress: Number,
            bluetoothAddressType: BluetoothAddressType,
            callback: (error: Error, result: BluetoothLEDevice) => void
        ): void;
        static fromBluetoothAddressAsync(
            bluetoothAddress: Number,
            callback: (error: Error, result: BluetoothLEDevice) => void
        ...
        static getDeviceSelectorFromAppearance(
            appearance: BluetoothLEAppearance
        ): String;
